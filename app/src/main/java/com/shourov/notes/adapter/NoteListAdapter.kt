...
class NoteListAdapter(private val context: Context, private var itemList: ArrayList<NoteTable>, private val itemClickListener: NoteItemClickListener): RecyclerView.Adapter<NoteListAdapter.ItemViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.single_note_item, parent, false)
    ...
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBind(currentItem: NoteTable, position: Int) {
            val bgColorList = context.resources.getStringArray(R.array.bgColorList)
